...
public class ZborServiceTest {
    ...
    public static void setup(){
        ...
        destinatie=Optional.of(new Destinatie("Ungaria","Budapesta", Destinatie.ZonaCovid.GALBEN));
    ...
    public void testAddAvion(){
        ...
        ClientException clientException=assertThrows(ClientException.class, ()->zborService.addAvion(avion.get(),user_client.get().getEmail(),user_client.get().getParola()));
